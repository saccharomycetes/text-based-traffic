...
class roberta_train():
    ...
    def train(self):
        ...
        logging.basicConfig(format = '%(asctime)s - %(levelname)s - %(name)s -   %(message)s',
                            ...
                            level = logging.INFO ,
                            filename=log_file)
        os.system("cp train.py %s" % os.path.join(self.args.output_dir, 'train.py'))
...
def main():
    ...
    parser.add_argument("--acc_step", default=4, type=int,
                        help="accumulation step")
    parser.add_argument("--num_epoches", default=10, type=int,
                        help="number of epoches to train")
    args = parser.parse_args()

    args.output_dir = "../../models/supervised/" + args.data + "_" + args.test_type
    args.train_file = "../../data/supervised/" + args.data + "/" + args.test_type + "/train.jsonl"
    args.dev_file = "../../data/supervised/" + args.data + "/" + args.test_type + "/test.jsonl"
